; ModuleID = '/home/omerfaruk/Projects/okul/BOB/BOB/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
declare void @apatb_leading_zero_count_hw(%"struct.ap_uint<6>"*, %"struct.ap_int<32>"*)
...
define void @leading_zero_count_hw_stub_wrapper(%"struct.ap_uint<6>"*, %"struct.ap_int<32>"*) #2 {
entry:
  call void @copy_out()
  call void @leading_zero_count_hw_stub(%"struct.ap_uint<6>"* %0, %"struct.ap_int<32>"* %1)
  call void @copy_in()
  ret void
}

declare void @leading_zero_count_hw_stub(%"struct.ap_uint<6>"*, %"struct.ap_int<32>"*)

; Function Attrs: argmemonly noinline readonly willreturn
define void @apatb_leading_zero_count_ir(%"struct.ap_uint<6>"* %ret, %"struct.ap_int<32>"* nocapture readonly %input) #3 {
entry:
  call fastcc void @copy_in()
  %0 = alloca %"struct.ap_uint<6>"
  call void @apatb_leading_zero_count_hw(%"struct.ap_uint<6>"* %0, %"struct.ap_int<32>"* %input)
  %1 = load volatile %"struct.ap_uint<6>", %"struct.ap_uint<6>"* %0
  call void @copy_back()
  %2 = load volatile %"struct.ap_uint<6>", %"struct.ap_uint<6>"* %0
  store %"struct.ap_uint<6>" %2, %"struct.ap_uint<6>"* %ret
  ret void
}
