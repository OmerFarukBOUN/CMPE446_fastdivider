set moduleName leading_zero_count
set isTopModule 1
...
set C_modelName {leading_zero_count}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "LUT_array_i", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.LUT_array_i_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	leading_zero_count {
		input_r {Type I LastRead 0 FirstWrite -1}
		LUT_array_i {Type I LastRead -1 FirstWrite -1}}}
