...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "divider.autotvin.dat"
	set constFileTvOut       "divider.autotvout.dat"
	set constFileHdlTvIn     "divider.autohdltvin.dat"
	set constFileHdlTvOut    "divider.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
