...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "leading_zero_count.autotvin.dat"
	set constFileTvOut       "leading_zero_count.autotvout.dat"
	set constFileHdlTvIn     "leading_zero_count.autohdltvin.dat"
	set constFileHdlTvOut    "leading_zero_count.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
